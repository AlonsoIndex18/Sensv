...
#pragma warning restore 0109
        ...
        public void Update()
        {
            ...
            if(Input.touchCount>0){
                rotation = Input.GetTouch(0).deltaPosition.x/2;
                acceleration = (Input.touchCount)/2.0f;
            }else{
            ...
            if ((Input.GetButton("Jump") && shootingTimer <= 0.0)||Input.GetTouch(0).phase == TouchPhase.Ended)
            {
                shootingTimer = 0.2f;
